...
class EyeDropOverlay extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    double top = cursorPosition!.dy + (_gridSize / 2);
    if (cursorPosition!.dy > screenSize.height * 0.8) {
      top = cursorPosition!.dy - _gridSize * 3 / 2;
    } else {
    ...
    return IgnorePointer(
      ...
      child: Container(
        foregroundDecoration: BoxDecoration(
          ...
          border: Border.all(
            width: 8,
            color: colors.isEmpty ? Colors.white : colors.center,
          ),
        ),
        width: _gridSize,
        height: _gridSize,
